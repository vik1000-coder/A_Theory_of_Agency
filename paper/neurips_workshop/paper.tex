...
the system less likely to refuse one side of a matched pair, but the answers it newly allows
...
role fit, and viewpoint-symmetry behavior under otherwise matched conditions. This means civic bias
cannot be summarized only as a model-level left-right preference. It also appears as
context-conditioned access to assistance.
